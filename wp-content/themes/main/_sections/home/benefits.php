<div class="recruit-home-section" id="environment">
  ...
  <div class="recruit-home-benefits">

    <div class="recruit-home-benefits-bg">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/public/img/benefits/bg.svg" alt="制度・環境・文化" width="880" height="550" loading="lazy">
    </div>
    ...
    <div class="recruit-home-benefits-item reverse">
      ...
      <div class="recruit-home-benefits-item-text fade-up">
        ...
        <br>
        コミュニケーションは基本的に日本語なので、英語は喋れなくても大丈夫です。もちろん、自分から多言語コミュニケーションに挑戦したいという方も大歓迎！日々のやり取りのなかで、自分の言語力もアップできるはず。
        <br>
        外国籍の方に対するイベントなども実施してるため、自然とグローバルな環境でスキルを磨くことができます。
        </span>
      </div>
    </div>
    ...
    <div class="recruit-home-benefits-item">
      ...
      <div class="recruit-home-benefits-item-text fade-up">
        <span>
          ...
          <br>
          年間休日120日以上で5日以上の長期休暇を取ることも可能なので、年に1回海外旅行に行っているというスタッフも。<br>
          スタッフがイキイキしていると、よりよいパフォーマンスが発揮できると考えているため、働く環境にもこだわっています。<br>
          <br>
          しんどいことも楽しいことも全て含めて人生です。<br>
          仕事を通して、メンバーが「自分の人生が豊かになった」と思えるような風土づくりを行っています。
        </span>
      </div>
    </div>
